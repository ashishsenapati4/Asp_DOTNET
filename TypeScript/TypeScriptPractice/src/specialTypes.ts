...
let var1: unknown = "AString"

function ProcessValue(variable: unknown)
{
...
//Type: 'never'
type Shape = {"kind":'circle',"radius":number} | {"kind":'square', "side":number} | {'kind':'triangle', "bahu":number}
...
const mySquare:Shape = { kind:'square', side:8}
